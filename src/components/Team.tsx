            ...
            >
              ...
              <div className="px-6 pb-8 flex-grow flex flex-col items-center text-center">
                ...
                <div className="mt-auto flex items-center gap-3">
                  ...
                  <a href={`mailto:${member.email}`} className="w-10 h-10 rounded-full bg-slate-50 border border-slate-200 flex items-center justify-center text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-all hover:scale-110">
